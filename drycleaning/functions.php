<?php
	...
	function myload_styles(){
		wp_enqueue_style("style",get_stylesheet_uri(),array(),"2.4.0");
	...
	function vl_register_setting(){
		...
		add_settings_field("vl_phone_main_id2","Телефон2","vl_phone_main_cb2","vl_options_page","vl_contact_section_id", array("label_for"=>"vl_phone_main_id2"));
		...
		add_settings_field("vl_tg_main_id","Telegram","vl_tg_main_cb","vl_options_page","vl_contact_section_id",
		array("label_for"=>"vl_tg_main_id"));
		
		add_settings_field("vl_viber_main_id","Viber","vl_viber_main_cb","vl_options_page","vl_contact_section_id",
		array("label_for"=>"vl_viber_main_id"));	
	...
	function vl_phone_main_cb2(){
		$options=get_option('vl_options');
		?>
			<input type="text" id="vl_phone_main_id2" name="vl_options[phone_main2]" value="<?php echo esc_attr($options['phone_main2']); ?>" class="regular-text">
		<?php
	}	
	...
	function vl_email_main_cb(){
		$options=get_option('vl_options');
		?>
			<input type="text" id="vl_email_main_id" name="vl_options[email_main]" 
			value="<?php echo esc_attr($options['email_main']); ?>" class="regular-text">
		<?php
	}
	...
	function vl_tg_main_cb(){
		$options=get_option('vl_options');
		?>
			<input type="text" id="vl_tg_main_id" name="vl_options[tg_main]" value="<?php echo esc_attr($options['tg_main']); ?>" class="regular-text">
		<?php
	}

	function vl_viber_main_cb(){
		$options=get_option('vl_options');
		?>
			<input type="text" id="vl_viber_main_id" name="vl_options[viber_main]" value="<?php echo esc_attr($options['viber_main']); ?>" class="regular-text">
		<?php
	}
